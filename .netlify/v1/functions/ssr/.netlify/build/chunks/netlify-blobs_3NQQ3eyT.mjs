...
var Store = class _Store {
  ...
  async delete(key) {
    ...
    if (![200, 204, 404].includes(res.status)) {
      throw new BlobsInternalError(res, { method: "delete" /* DELETE */, storeName: this.name });
    }
  }
  async deleteAll() {
  ...
  async set(key, data, options = {}) {
    return withSpan(options.span, "blobs.set", async (span) => {
      ...
      throw new BlobsInternalError(res, { method: "put" /* PUT */, storeName: this.name });
    });
  }
